...
def process_table(filename):
  ...
  data = pd.read_table(filename,delimiter=':',header = None, skiprows=4)
...
# Prepare DATA
filename1 = 'usmd-prd-brhn01'
failed, ru_wallclock, ru_utime, ru_stime, ru_maxrss, ru_minflt, ru_majflt,ru_inblock, ru_oublock, ru_nvcsw, ru_nivcsw, granted_pe, slots, cpu, men, io, iow, maxvmem, label1 = process_table(filename1)
data1 = np.hstack((failed, ru_wallclock, ru_utime, ru_stime, ru_maxrss, ru_minflt, ru_majflt,ru_inblock, ru_oublock, ru_nvcsw, ru_nivcsw, granted_pe, slots, cpu, men, io, iow, maxvmem ))
